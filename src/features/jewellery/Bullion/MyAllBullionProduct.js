       ...
       <View style={{
        ...
        <View style={{ alignItems: "center" , flexDirection : "row"}}>
          ...
          <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddBullion")}>
...
justifyContent: 'space-between',
        ...
        data={Used_Product}
        renderItem={({item}) => (
    <TouchableOpacity onPress={() => navigation.navigate("BullionProduct")} style={{
...
export default MyAllBullionProduct;
