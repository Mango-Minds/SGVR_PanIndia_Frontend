...
export default function EditBullion({ navigation }) {
 ...
 const dispatch = useDispatch();
  ...
  const addProduct = async () => {
    ...
    if (
      registerDetails.BullionName === "" ||
      registerDetails.BullionDescription === "" ||
      registerDetails.Goldavailable === "" ||
        registerDetails.price === ""
     ) {
      dispatch(
        ErrorToggle({
          type: "error",
    ...
    data.append("BullionName", registerDetails.BullionName);
    data.append("BullionDescription", registerDetails.BullionDescription);
    data.append("Goldavailable", registerDetails.Goldavailable);
          ...
          >
            ...
            <FormSection style={{ paddingTop: 0 }}>
              <LoginInputField
                ...
                value={registerDetails.BullionName}
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, BullionName: text })
                }
              />
                 <UselessTextInput
                            multiline
                            numberOfLines={3}
                            name="BullionDescription"
                            placeholder="Bullion Description*"
                            value={registerDetails.BullionDescription}
                            onChangeText={(text) =>
                                setRegisterDetails({ ...registerDetails, BullionDescription: text })
                            }
                ...
                placeholderTextColor="#9B9B9B"
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, Goldavailable: text })
                }
