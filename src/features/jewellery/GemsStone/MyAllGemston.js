       ...
       <View style={{
        ...
        <View style={{ alignItems: "center" , flexDirection : "row"}}>
          ...
          <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddGemsStone")}>
...
justifyContent: 'space-between',
        ...
        data={Used_Product}
        renderItem={({item}) => (
    <TouchableOpacity onPress={() => navigation.navigate("GemstoneProduct")} style={{
...
export default MyAllGemsProduct;
