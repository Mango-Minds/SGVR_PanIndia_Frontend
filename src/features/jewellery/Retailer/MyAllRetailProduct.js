       ...
       <View style={{
        ...
        <View style={{ alignItems: "center" , flexDirection : "row"}}>
          ...
          <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate("AddRetailProduct")}>
...
justifyContent: 'space-between',
        ...
        data={Used_Product}
        renderItem={({item}) => (
    <TouchableOpacity onPress={() => navigation.navigate("RetailProduct")} style={{
...
export default MyAllRetailProduct;
