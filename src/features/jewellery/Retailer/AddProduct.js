...
export default function AddRetailProduct({ navigation }) {
  ...
  const addProduct = async () => {
    try {
      ...
      formData.append("productCategory", registerDetails.productType);
      ...
      formData.append("vendorUsername", user.roleData.username);
      formData.append(
        "weightPerProduct",
  ...
  const ConditionData = ["old", "new", "refurbished"];
