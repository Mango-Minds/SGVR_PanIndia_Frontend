  ...
  return (
    ...
    >
      {/* <RowBetween style={{ paddingTop: 24 }}>
        ...
        <IconButton icon="delete" style={{ marginRight: 10 }} />
  <IconButton icon="pencil" style={{ marginRight: 0 }} />
        <IconButton
          icon="bell-outline"
      ...
      ></IconButton>
       <IconButton
        icon="pencil-outline"
        onPress={() => navigation.navigate("EditRetailProduct")}
      ></IconButton>
      <IconButton
        icon="bell-outline"
      ...
      <View style={{ padding: "4%" }}>
        ...
        <View style={{ flexDirection: "row" }}>
          <View style={styles.qq}>
            <Text style={styles.qqtxt}>Quality: 22k</Text>
          </View>
          <View style={styles.qq}>
            <Text style={styles.qqtxt}>Quantity: 50 pieces</Text>
          </View>
        </View>
        <View style={{ flexDirection: "row" , marginTop : "5%" }}>
          <Text style={{ fontSize: 15 , fontWeight : "500"}}>No. of Pieces : </Text>
          <Text style={{ fontSize: 15, color: "#D4AF37", fontWeight : "500" }}>500</Text>
        </View>
        <View style={{ flexDirection: "row" , marginTop : "5%" }}>
          <Text style={{ fontSize: 15 , fontWeight : "500"}}>Weight per product : </Text>
          <Text style={{ fontSize: 15, color: "#D4AF37", fontWeight : "500" }}>10 gm</Text>
        </View>
        <View style={{ flexDirection: "row" , marginTop : "5%" }}>
          <Text style={{ fontSize: 15 , fontWeight : "500"}}>Worker : </Text>
          <Text style={{ fontSize: 15, color: "#D4AF37", fontWeight : "500" }}>Worker 1</Text>
        </View>
