import {
  ...
  const GemstoneProductDetails = ({ route }) => {
        ...
        <View style={{ padding: "4%" }}>
          ...
          <View style={{ flexDirection: "row" }}>
           <View style={styles.qq}>
              <Text style={styles.qqtxt}>Quantity: 50 kg</Text>
            </View>
          </View>
          <View style={{ flexDirection: "row" , marginTop : "5%" }}>
            <Text style={{ fontSize: 15 , fontWeight : "500"}}>Price (per CARAT) : </Text>
            <Text style={{ fontSize: 15, color: "#D4AF37", fontWeight : "500" }}>₹ 500/-</Text>
          </View>
          <View style={{ flexDirection: "row" , marginTop : "5%" }}>
            <Text style={{ fontSize: 15 , fontWeight : "500"}}>Price (per GRAM) : </Text>
            <Text style={{ fontSize: 15, color: "#D4AF37", fontWeight : "500" }}>₹ 200/-</Text>
          </View>
          <View style={{ flexDirection: "row" , marginTop : "5%" , marginBottom : "5%" }}>
            <Text style={{ fontSize: 15 , fontWeight : "500"}}>Price (per Product) : </Text>
            <Text style={{ fontSize: 15, color: "#D4AF37", fontWeight : "500" }}>₹ 250/-</Text>
          </View>
          <Divider />
          <View>
  ...
  export default GemstoneProductDetails;
