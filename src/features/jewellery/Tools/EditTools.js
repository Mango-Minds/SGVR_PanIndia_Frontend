...
export default function EditTools({ navigation, route}) {
  ...
  const [modifiedDetails, setModifiedDetails] = useState({
    ToolName: tool.name,
    ToolDescription: tool.about,
    price: tool.product_price,
  });
  

  console.log(modifiedDetails, "modifiedDetails");
  ...
  const addProduct = async () => {
    ...
    if (
      modifiedDetails.ToolName === "" ||
      modifiedDetails.ToolDescription === "" ||
      modifiedDetails.price === ""
    ) {
      dispatch(
        ErrorToggle({
          type: "error",
    ...
    data.append("ToolName", modifiedDetails.ToolName);
    data.append("ToolDescription", modifiedDetails.ToolDescription);
    data.append("price", modifiedDetails.price);
          ...
          >
            ...
            <FormSection style={{ paddingTop: 0 }}>
              <LoginInputField
                ...
                value={modifiedDetails.ToolName}
                onChangeText={(text) =>
                  setModifiedDetails({ ...modifiedDetails, ToolName: text })
                }
              />
              <UselessTextInput
                multiline
                ...
                value={modifiedDetails.ToolDescription}
                onChangeText={(text) =>
                  setModifiedDetails({
                    ...modifiedDetails,
