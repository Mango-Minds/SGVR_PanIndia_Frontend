  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.generalInfoContainer}>
        ...
        <View style={styles.userInfoContainer}>
          ...
          <View style={styles.socialContainer}>
            ...
            >
              <Text style={styles.linkText}>{followersCount} Followers</Text>
            </TouchableOpacity>
            <Text>    </Text>
            <TouchableOpacity
              onPress={() =>
            ...
            >
              <Text style={styles.linkText}>{followingCount} Following</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
      ...
      {educationData && educationData.length > 0 ? (
        ...
        <View style={styles.aboutMeContainer}>
          <Text style={styles.aboutMeTitle}> Add Education</Text>
        </View>
      )}
      ...
      {jobExperienceData && jobExperienceData.length > 0 ? (
        jobExperienceData.map((jobExperience, index) => (
          <View key={index} style={styles.educationSection}>
            <Text style={styles.educationTitle}>Job Experience</Text>
        ...
        <View style={styles.aboutMeContainer}>
          <Text style={styles.aboutMeTitle}> Add Job experience</Text>
        </View>
      )}

      <View style={styles.aboutMeContainer}>
        <Text style={styles.aboutMeTitle}>Resume</Text>
        <TouchableOpacity
          style={styles.editPencilIconContainer}
        ...
        {resumeUri ? (
          ...
          <Text style={styles.uploadButtonText}>Add Resume</Text>
        )}
      </View>
              ...
              <View style={styles.modalResumeContent}>
                {uploadedDoc ? (
                  ...
                  >
                    ...
                    <Text style={styles.resumeOptionText}>Document</Text>
                  </TouchableOpacity>
                )}
              </View>
            </View>
