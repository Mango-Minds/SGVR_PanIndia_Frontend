              ...
              <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 12 }}>
                {[
                  ...
                  <View key={idx} style={{ marginRight: 10 }}>
                    <TouchableOpacity style={[styles.categoryTab, idx === 0 && styles.categoryTabActive]}>
                      <Text style={[styles.categoryTabText, idx === 0 && styles.categoryTabTextActive]}>{label}</Text>
                    </TouchableOpacity>
                  </View>
                ))}
              </ScrollView>
