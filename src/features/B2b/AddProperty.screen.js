...
export default function AddProperty({ navigation }) {
  ...
  const [amenitiesArray, setAmenitiesArray] = React.useState([]);
  ...
  const addAmenities = () => {
    if (amenities.length !== 0) {
      setAmenitiesArray([...amenitiesArray, amenities]);
      setAmenities("");
    }

    
  };
  const removeThisAmenities = (amenities) => {
    const newAmenitiesArray = amenitiesArray.filter((item) => {
      return item !== amenities && item;
    });
          ...
          >
            ...
            <LoginInputField
              ...
              <LoginInputField
                ...
                underlineColor="transparent"
                placeholderTextColor="#9B9B9B"
                value={registerDetails.localityname}
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, localityname: text })
                }
              />
               <LoginInputField
                selectionColor="#d4af37"
                activeUnderlineColor="#d4af37"
                style={styles.input}
                placeholder="Landmark Distance (KM)*"
                underlineColor="transparent"
                placeholderTextColor="#9B9B9B"
                keyboardType="numeric"
                value={registerDetails.landmarkdistance}
                maxLength={6}
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, landmarkdistance: text })
                }
              />
              <LoginInputField
                selectionColor="#d4af37"
...
<LoginInputField
                ...
                activeUnderlineColor="#d4af37"
                style={styles.input}
                placeholder="No. of Floors in Property"
                underlineColor="transparent"
                placeholderTextColor="#9B9B9B"
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, nopropertyFloor: text })
                }
                value={registerDetails.nopropertyFloor}
              />
            ...
            <LoginInputField
              ...
              <LoginInputField
                ...
                activeUnderlineColor="#d4af37"
                style={styles.input}
                placeholder="Super Built Area (in sqft)*"
                underlineColor="transparent"
                placeholderTextColor="#9B9B9B"
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, propertybuiltinarea: text })
                }
                value={registerDetails.propertybuiltinarea}
              />
               <LoginInputField
                color
                selectionColor="#d4af37"
              ...
              <Menu
                ...
                anchor={
                  <MenuLead
                    ...
                    style={{ height: 50 }}
                    title={registerDetails.Propertystatus || "Property Status "}
                    bgColor="#F0F0F0"
                    textcolor="Property Status "
                  />
                }
              >
                <MenuItem
              ...
              <Menu
                ...
                anchor={
                  <MenuLead
                    ...
                    style={{ height: 50 }}
                    title={registerDetails.PropertyFacing || "Property Facing"}
                    bgColor="#F0F0F0"
                    textcolor="Property Facing"
                  />
                }
              >
                <MenuItem
...
<View style={{ paddingHorizontal: 0 }}>
            ...
            <LoginInputField
                ...
                activeUnderlineColor="#d4af37"
                style={styles.input}
                placeholder="Owner Availablility (e.g. Sunday, Monday, etc.)"
                underlineColor="transparent"
                placeholderTextColor="#9B9B9B"
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, availableday: text })
                }
                value={registerDetails.availableday}
              />
              <View style={{ paddingHorizontal: 0 }}>
              <Menu
                style={{
                ...
                anchor={
                  <MenuLead
                    ...
                    style={{ height: 50 }}
                    title={registerDetails.postedby || "Posted By "}
                    bgColor="#F0F0F0"
                    textcolor="postedby "
                  />
                }
            ...
            <LoginInputField
                ...
                activeUnderlineColor="#d4af37"
                style={styles.input}
                placeholder="Preffered Tenant Type"
                underlineColor="transparent"
                placeholderTextColor="#9B9B9B"
                onChangeText={(text) =>
                  setRegisterDetails({ ...registerDetails, prefferedTenent: text })
                }
                value={registerDetails.prefferedTenent}
              />
               <View
                style={{
                  flexDirection: "row",
              ...
              >
                {amenitiesArray.length > 0 &&
                  amenitiesArray.map((amenities, index) => (
                    <View
                      key={index}
                      style={{
                        padding: 6,
                    ...
                    >
                      ...
                      <TouchableOpacity onPress={() => removeThisAmenities(amenities)}>
                        <Icon
                          style={{ opacity: 0.3 }}
                          name="close"
                          size={20}
