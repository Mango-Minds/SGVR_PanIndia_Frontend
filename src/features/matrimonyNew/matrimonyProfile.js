...
const MyMatrimonyProfile = ({ route }) => {
  ...
  //     setUserData(data);
  //     setUserDetails(data.user.roleData?.MatrimonyUser || data.user.roleData?.MatrimonyVendor);
  ...
  try {
    ...
    setUserDetails(
      translatedData.user.roleData?.MatrimonyUser ||
      translatedData.user.roleData?.MatrimonyVendor
    );

    console.log("user matrimony data", translatedData);
  ...
  return (
    <>
      <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
        <ProfileHeader title={t("my_profile")}/>
        <ScrollView>
            ...
            >
              ...
              <View style={style.contactButtonDetails}>
                ...
                {[
                  ...
                  >
                    <Text style={style.EditButtonText}>{t("view_shop_profile")}</Text>
                  </TouchableOpacity>
                )}
                {[
                  "matrimonyVendor",
                  ...
                  >
                    <Text style={style.EditButtonText}>{t("edit_shop_profile")}</Text>
                  </TouchableOpacity>
                )}
              </View>
            </View>
