...
//         // Call updateModifiedDetails with fetched userRoleData
//         updateModifiedDetails(data.user.roleData);
//       } else {
//         throw new Error("Failed to fetch user");
//       }
//     } catch (error) {
...
//   // Function to update modifiedDetails based on userRoleData
//   const updateModifiedDetails = (userRoleData) => {
//     setModifiedDetails({
//       name: userRoleData?.name ?? null,
//       gender: userRoleData?.gender ?? null,
//       images: userRoleData?.images ?? [],
//       aboutMe: userRoleData?.aboutMe ?? null,
...
//   const handleUpdate = async () => {
//     console.log("Modofoed details json:", JSON.stringify(modifiedDetails));
//     console.log("Modofoed details:", modifiedDetails);
//     await dispatch(setLoadingInBtn(true));
//     try {
//       const response = await fetch(
//         `${BASEAPIURL}/matrimony/matrimonyUser/edit/${userId}`,
...
//             Authorization: `Bearer ${token}`,
//           },
//           body: JSON.stringify(modifiedDetails), // Convert modifiedDetails to JSON string
//         }
//       );
//       await dispatch(setLoadingInBtn(false));
