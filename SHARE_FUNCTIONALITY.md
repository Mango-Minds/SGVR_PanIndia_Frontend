...
## Overview
The Pan India app now uses URL-based sharing instead of sending notifications to friends. This approach is more scalable and allows users to share content across different platforms.
